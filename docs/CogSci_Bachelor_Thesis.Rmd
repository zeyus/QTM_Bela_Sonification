...
This has "Exponentiate = TRUE", and no "add_global_p". This compares the angle model with the null angle model
...
simple lm, but grouped with trial, subject pair and condition this is using the formula `delta_y ~ condition`
