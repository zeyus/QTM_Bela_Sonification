...
Motion capture data were sent via UDP packets over USB networking to a Bela Mini computer running version `r bela_version` running a custom C++ program [^1]. The main program loop 

[^1]: Source, data and analysis are available at `r rmarkdown::metadata$repository`
