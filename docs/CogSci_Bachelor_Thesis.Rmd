...
plot_title <- paste(
    ...
    "The mean normalized path distance is shown as a point (+), the 20th and 80th percentiles are shown as dashed lines",
    "and the 50th percentile is shown as a solid line.",
