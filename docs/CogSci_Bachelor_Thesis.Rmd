...
## Integrating sonification and joint action [section motivating the current study]
...
plot_title <- paste(
    ...
    "), task sonification condition normalized distance mean = ",
    dtw_res$dist_mean[dtw_res$condition == "Task"],
    "(sd = ",
    dtw_res$dist_sd[dtw_res$condition == "Task"],
    "), sync sonification condition normalized distance mean = ",
