...
```{r sensory-dissonance, fig.align='center', fig.cap='Sensory dissonance of sine waves by interval for five frequencies. Figure courtesy (ref:setharesTuningTimbreSpectrum2010)', out.width="100%"}
# load figure image
...
ugd(width=1600, height=1200)
ggplot(data = data, mapping = aes(x = x, y = y, fill = z)) +
  geom_raster() +
