...
\fancyhead[L]{\footnotesize{\sffamily Backström, L. (202004875, LB) and Ring, L. (202009983, LR).}}
\fancyhead[C]{}
\fancyhead[R]{\footnotesize{\sffamily Bachelor's Project (147201E020). Exam code: ABC123.}}
...
\newgeometry{includemp, reversemp, left=1.0cm, marginparwidth=4.5cm, marginparsep=0.5cm}
  ...
  \marginpar{
    ...
    {\bfseries Programme}\\Bachelor of Cognitive Science\\[1mm]
    {\bfseries Course}\\Bachelor's Project (147201E020)\\[1mm]
    {\bfseries Exam code:} ABC123\\[1mm]
