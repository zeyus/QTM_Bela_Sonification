...
\caption{Sensory dissonance of sine waves by interval for five frequencies. Figure courtesy (ref:setharesTuningTimbreSpectrum2010)}\label{fig:sensory-dissonance}
\end{figure}
...
\caption{Plot of mean absolute instantaneous phase angles of experimental conditions with the length of the needles representing the standard deviation as a percentage of 90 degrees. No Sonification condition mean phase angle =  8.86 (sd =  0.07 ) degrees, sync sonification condition mean phase angle =  8.75 (sd =  0.08 ) degrees, task sonification condition mean phase angle =  14.21 (sd =  0.22 ) degrees.}\label{fig:mean-instantaneous-phase-angle-circular-plot}
\end{figure}
